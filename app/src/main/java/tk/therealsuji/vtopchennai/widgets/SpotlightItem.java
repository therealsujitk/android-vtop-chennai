...
public class SpotlightItem extends LinearLayout {
    ...
    public SpotlightItem(Context context) {
        super(context);
    ...
    private void initialize() {
        ...
        this.announcementType.setBackground(ContextCompat.getDrawable(this.context, R.drawable.background_recycler_view_item_icon));
        ...
        this.setBackground(ContextCompat.getDrawable(this.context, R.drawable.background_recycler_view_item_default));
    ...
    public void setFirst() {
        this.setBackground(ContextCompat.getDrawable(this.context, R.drawable.background_recycler_view_item_first));
    }

    public void setLast() {
        this.setBackground(ContextCompat.getDrawable(this.context, R.drawable.background_recycler_view_item_last));
    }

    public void setSingle() {
        this.setBackground(ContextCompat.getDrawable(this.context, R.drawable.background_recycler_view_item_single));
    }
